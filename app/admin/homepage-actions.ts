...
export async function updateHero(formData: FormData) {
  ...
  const headline_emphasis = String(formData.get("headline_emphasis") || "");
  ...
  const existingMediaType = String(formData.get("existingMediaType") || "image");

  let media_url = existingMediaUrl ? String(existingMediaUrl) : null;

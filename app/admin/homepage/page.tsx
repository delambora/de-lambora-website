    ...
    <div className="space-y-16">
      ...
      <section className="border-t border-hairline pt-14">
        ...
        >
          ...
          <p className="text-xs text-sand">
            The image will be positioned and cropped to fit
            the promo banner before uploading.
          </p>
      ...
      <section className="border-t border-hairline pt-14">
        ...
        <p className="text-sand text-sm mb-10 max-w-xl">
          Edit the three collection tiles shown between the
          Promo Banner and Hero 2 on the homepage.
        </p>

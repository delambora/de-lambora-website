  ...
  return (
    <main className="min-h-screen px-6 py-16 md:px-12 md:py-24">
      <div className="mx-auto max-w-4xl">
        ...
        <Link
          href="/"
          className="text-sm text-sand hover:text-wineLight"
        >
          ← Back to De Lambora
        </Link>
        ...
        <div className="mt-16 space-y-12">
          ...
          <section>
            ...
            <p className="mt-4 text-sm leading-relaxed text-sand">
              ...
              Once dispatched, delivery usually takes approximately
              3–7 business days depending on your location and courier
              service.
            </p>
          ...
          <section>
            ...
            <p className="mt-4 text-sm leading-relaxed text-sand">
              Once your order has been dispatched, tracking details will
              be shared with you so that you can follow your shipment.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-sm leading-relaxed text-sand">
              ...
              photographs and your order details.
            </p>
          </section>
